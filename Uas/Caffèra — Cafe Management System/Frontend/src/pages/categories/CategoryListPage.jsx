        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {categories.map((cat) => (
            <Card
              key={cat.id}
              hoverEffect
              className="flex flex-col justify-between bg-white border-stone-200"
            >
              <div>
                <div className="flex items-start justify-between gap-2 mb-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-stone-400">ID: #{cat.id}</p>
                    </div>
                  </div>
              ...
              {isAdmin && (
                <div className="mt-4 pt-3 border-t border-stone-100 flex items-center justify-end gap-2">
                  <button
                    ...
                    className="p-1.5 rounded-lg border border-stone-200 text-stone-600 hover:bg-stone-100 hover:text-stone-900 transition-colors text-xs font-bold inline-flex items-center gap-1 cursor-pointer"
                  >
                  ...
                  <button
                    ...
                    className="p-1.5 rounded-lg border border-rose-100 text-rose-600 hover:bg-rose-50 transition-colors text-xs font-bold inline-flex items-center gap-1 cursor-pointer"
                  >
